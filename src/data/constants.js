...
export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1_hGaqOm5l3bCM1lZLwsI4UzluZppyvEW/view?usp=drivesdk",
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Spotify CLone it is just a clone to Spotify Web app using Html Css and Vanila Js that allows users to search for, play, and pause their favorite music on demand ",
    image:
